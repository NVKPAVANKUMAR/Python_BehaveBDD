...
__all__ = [ 'OLE_YPOS_HIMETRIC', 'Picture', 'FONTITALIC',
           'OLE_XPOS_PIXELS', 'OLE_YPOS_PIXELS', 'IFontEventsDisp',
           'VgaColor', 'LoadPictureConstants', 'OLE_YSIZE_CONTAINER',
           'OLE_TRISTATE', 'Monochrome', 'Checked', 'OLE_HANDLE',
           'Font', 'OLE_XPOS_CONTAINER', 'OLE_YSIZE_HIMETRIC', 'Gray',
           'Color', 'StdPicture', 'Default', 'OLE_XSIZE_PIXELS',
           'IPictureDisp', 'FontEvents', 'FONTSTRIKETHROUGH',
           'IFontDisp', 'Unchecked', 'IFont', 'OLE_CANCELBOOL',
           'StdFont', 'OLE_XSIZE_CONTAINER', 'OLE_OPTEXCLUSIVE',
           'FONTUNDERSCORE', 'OLE_COLOR', 'FONTSIZE',
           'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD', 'FONTNAME',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'IPicture',
